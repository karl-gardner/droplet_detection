...
9) Repeat steps 7 and 8 with the cell dataset in the link provided: <a href="https://universe.roboflow.com/karl-gardner-kmk9u/cropped_drops2/1">
  <img src="https://user-images.githubusercontent.com/91646805/156674789-2b15149f-ec4a-4c3b-8005-611b660490e6.svg" height="32"/></a>.  This dataset only needs to be copied into the yolov3.ipynb notebook since it is not used in the yolov5.ipynb notebook.
